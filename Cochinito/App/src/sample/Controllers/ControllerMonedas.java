...
public class ControllerMonedas implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Moneda1.setOnAction(event -> {
            File f = new File("src\\sample\\Sonido\\1peso.mp3");
            URI u = f.toURI();
        ...
        Moneda2.setOnAction(event -> {
            File f = new File("src\\sample\\Sonido\\2pesos.mp3");
            URI u = f.toURI();
            AudioClip sonido = new AudioClip(""+u);
            sonido.play();
        });
        ...
        Moneda5.setOnAction(event -> {
            File f = new File("src\\sample\\Sonido\\5pesos.mp3");
            URI u = f.toURI();
            AudioClip sonido = new AudioClip(""+u);
            sonido.play();
        });
        ...
        Moneda10.setOnAction(event -> {
            File f = new File("src\\sample\\Sonido\\10pesos.mp3");
            URI u = f.toURI();
            AudioClip sonido = new AudioClip(""+u);
            sonido.play();
        });
        ...
        Billete20.setOnAction(event -> {
            File f = new File("src\\sample\\Sonido\\20pesos.mp3");
            URI u = f.toURI();
            AudioClip sonido = new AudioClip(""+u);
            sonido.play();
        });
        ...
        Billete50.setOnAction(event -> {
            File f = new File("src\\sample\\Sonido\\50pesos.mp3");
            URI u = f.toURI();
            AudioClip sonido = new AudioClip(""+u);
            sonido.play();
        });
        ...
        Billete100.setOnAction(event -> {
            File f = new File("src\\sample\\Sonido\\100pesos.mp3");
            URI u = f.toURI();
            AudioClip sonido = new AudioClip(""+u);
            sonido.play();
        });
        ...
        Billete200.setOnAction(event -> {
            File f = new File("src\\sample\\Sonido\\200pesos.mp3");
            URI u = f.toURI();
            AudioClip sonido = new AudioClip(""+u);
            sonido.play();
        });
